...
import 'package:carpicost_app/Transporte/Transporte.dart';
...
class ManoDeObra extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: MyHomePage(title: 'Mano De Obra'),
    );
  }
}
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void getMateriales() async {
    CollectionReference collectionReference =
        FirebaseFirestore.instance.collection("ManoDeObra");
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: Column(children: [
          ...
          Row(children: <Widget>[
            Text("Ingresar equipo de trabajo",
                                      ...
                                      Future<void> updateMaterial() {
                                        return mate
                                            ...
                                            .catchError((error) =>
                                                Fluttertoast.showToast(
                                                    msg:
                                                        "Fallo al actualizar Mano de obra: $error",
                                                    toastLength:
                                                        Toast.LENGTH_SHORT,
                                                    gravity:
                                                        ToastGravity.CENTER,
...
Widget botonSiguiente(BuildContext context) {
  return FlatButton(
      ...
      onPressed: () {
        Navigator.push(
            context, MaterialPageRoute(builder: (context) => Transporte()));
      },
      child: Text(
        "Siguiente",
